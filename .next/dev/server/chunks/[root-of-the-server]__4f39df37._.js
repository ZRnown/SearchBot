...
async function GET(request, context) {
    try {
        ...
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminFetch"])(`/users/${id}`, undefined, token);
...
async function PUT(request, context) {
    try {
        ...
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminFetch"])(`/users/${id}`, {
            method: "PUT",
            headers: {
...
async function DELETE(request, context) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminFetch"])(`/users/${id}`, {
            method: "DELETE"
        }, token);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4f39df37._.js.map